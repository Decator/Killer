...
public class JMenu extends JPanel {
	...
	public void joinGameButton() {
		JButton joinGameButton = new JButton("Rejoignez la partie");
	...
	public void rulesPanel() {
		...
		JLabel rulestitleLabel = new JLabel("<html><p style='text-align: center; font-weight: bold; font-size: 20;'>Regles :</p></html>");
		...
		JLabel rulesLabel1 = new JLabel(" Le but du jeu du Killer consiste a etre le dernier des 4 joueurs en vie.");
		rulesPanel.add(rulesLabel1);
		JLabel rulesLabel2 = new JLabel(" Chaque tour vous aurez 6 des. Vous devrez faire un score d'au moins 30 ou de moins de 12.");
		rulesPanel.add(rulesLabel2);
		JLabel rulesLabel3 = new JLabel(" Pour cela, vous devrez prendre au moins un de a chaque lancer.");
		...
		JLabel rulesLabel7 = new JLabel(" Vous attaquerez d'autant de points que la difference.");
		rulesPanel.add(rulesLabel7);
		JLabel rulesLabel8 = new JLabel(" Pour ce faire, vous lancerez les des jusqu'a ce qu'il n'y ait plus de des avec le montant de l'attaque.");
