...
public class JMenu extends JPanel {
	...
	public void rulesPanel() {
		...
		JLabel rulesLabel1 = new JLabel(" Le but du jeu du Killer consiste à être le dernier en joueur en vie.");
		...
		JLabel rulesLabel6 = new JLabel("     - Sinon, vos points de vie augmenterons de la différence. De plus, vous pourrez attaquer un adversaire.");
		...
		JLabel rulesLabel8 = new JLabel(" Pour ce faire, vous lancerez les dés jusqu'à ce qu'il n'y ait plus de dés avec le montant de l'attaque.");
